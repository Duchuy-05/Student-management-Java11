...
public class floatinglabeltext extends javax.swing.JPanel {
    ...
    private boolean isLabelActive = false; // Trạng thái nhãn đã nổi lên trên
    ...
    public floatinglabeltext(String placeholder) {
        super();
        setLayout(null);
        this.labelFont = new Font("SansSerif", Font.PLAIN, 14); // Đặt font cứng
        ...
        textField.setBounds(10, 18, 180, 30);
        add(textField);
        ...
        textField.getDocument().addDocumentListener(new DocumentListener() {
            ...
            public void removeUpdate(DocumentEvent e) {
                if (textField.getText().isEmpty() && !isFocused) {
                    deactivateLabel();
                }
            }
